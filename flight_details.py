...
@app.callback( [
               ...
               Output(conponent_id='weather-plot', component_property='figure'),
...
def get_graph(entered_year):
    ...
    late_fig = pxline(avg_late, x='Month', y='AircraftDelay', color='Reporting_Airline', title='Average late aircraft delay time (minutes) by airline')
